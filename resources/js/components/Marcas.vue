            ...
            <template v-slot:conteudo>
                <div class="form-group">
                    <input-container-component 
                        ...
                        <input type="text" class="form-control" id="inputNome" aria-describedby="nomeHelp" placeholder="Nome da marca" v-model="nomeMarca">
                    </input-container-component>
                    {{nomeMarca}}
                </div>
                <div class="form-group">
                    <input-container-component 
                        ...
                        <input type="file" class="form-control-file" id="novoImagem" aria-describedby="nomeHelp" placeholder="Seleciona uma Imagem" @change="carregarImagem($event)">
                    </input-container-component>
                    {{arquivoImagem}}
                </div>
            </template>

            <!-- Rodapé com os botoes  -->
            <template v-slot:rodape>
